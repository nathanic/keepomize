...
class TestCliMain:
    ...
    @patch('sys.stdin')
    @patch('sys.stdout')
    def test_main_processes_secrets(self, mock_stdout, mock_stdin, mock_process_secret, mock_yaml):
    ...
    @patch('sys.stdin')
    @patch('sys.stderr')
    def test_main_process_secret_error(self, mock_stderr, mock_stdin, mock_process_secret, mock_yaml):
    ...
    @patch('sys.stdin')
    @patch('sys.stdout')
    def test_main_handles_none_documents(self, mock_stdout, mock_stdin, mock_process_secret, mock_yaml):
